...
class SuggestBookGivenTropeChain(Runnable): 
    ...
    def __init__(self, memory: bool = True):
        ...
        prompt_bot_return = PromptTemplate(
            ...
            and authors to their favorites list, receiving suggestions of books and authors, and creating a reading plan. Do not greet the user in the beggining of the message \
            as this is already in the middle of the conversation.
    ...
    def invoke(self, user_input, config):       
        result = self.extract_chain.invoke(user_input)
        trope = result.trope
