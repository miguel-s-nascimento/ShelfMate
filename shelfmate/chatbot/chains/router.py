...
class RouterChain(Runnable):
    def __init__(self, memory=False):
        ...
        prompt_template = PromptTemplate(
            ...
            They can ask for updating the following informations: password, email and the district they live in. Note that the district must be in Portugal following the portuguese writting.
