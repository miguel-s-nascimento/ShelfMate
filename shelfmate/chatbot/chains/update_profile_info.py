...
class ExtractInfoToUpdate(Runnable):
    def __init__(self, llm, memory=False):
        ...
        prompt_template = PromptTemplate(
            ...
            They are allowed to change their password, email and the district they live in. 
...
class UpdateUserInfoChain(Runnable):   
    ...
    def __init__(self, memory: bool = True) -> str:
        ...
        prompt_bot_return = PromptTemplate(
            ...
            The user asked for a change in their profile information and they are allowed to change their password, email and the district they live in. 
    ...
    def invoke(self, user_input, config):
        ...
        user_info = self.extract_chain.invoke(user_input)
        ...
        if user_info.info_to_change in ['username','user']:
            self.status = 'error_cannot_change_username'
